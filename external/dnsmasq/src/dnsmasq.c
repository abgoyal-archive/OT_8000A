...
/* --------|----------------|--------------------|--------------------------- */
/* 12/24/10| Wen.Ye         |         FR-320942  | Mobile network carrier DNS */
/*                                                 servers                    */
/*---------|----------------|--------------------|--------------------------- */
/* ========================================================================== */
...
static int check_android_listeners(fd_set *set) {
//begin port google's patch by wen.ye for bug 320942, 2012.10.24
    int retcode = 0;
    ...
    return retcode;
//end port google's patch by wen.ye for bug 320942, 2012.10.24
}
#endif
