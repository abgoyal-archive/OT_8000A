 ...
 * --------   ---     ----------------------------------------------------------
 * 09/21/12    WQF    Add dat method for audio parameters update on scribe5
 */
...
/*[PLATFORM]-Mod-BEGIN by TCTNB.WQF, 2012/9/21, It is just for cmd mode, scribe5 use video mode, so no need this check.*/
#ifndef CONFIG_MACH_MSM8X25_SCRIBE5
