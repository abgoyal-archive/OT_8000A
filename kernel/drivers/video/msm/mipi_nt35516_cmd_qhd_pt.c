...
/* -------------------------------------------------------------------------- */
/* Comments: This is the configuration of cmd mode for nt35516(qHD)           */
/*                                                                            */
/* File    : kernel/drivers/video/msm/mipi_nt35516_cmd_qhd_pt.c               */
/* Labels  :                                                                  */
/* -------------------------------------------------------------------------- */
/* ========================================================================== */
...
static int __init mipi_cmd_nt35516_qhd_pt_init(void)
{
	int ret;

	if (msm_fb_detect_client("mipi_cmd_nt35516_qhd"))
		return 0;
