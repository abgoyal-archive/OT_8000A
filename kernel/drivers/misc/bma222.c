...
* History:
*         Transplanted from ics project by TCTNB.XQJ,2012/08/20,g-sensor bma222 source file 
*******************************************************************************/
...
static int bma222_read_accel_xyz(bma_acc_t *acc)
{
    ...
    //printk("get acc xyz [%d][%d][%d] \n",acc->x, acc->y, acc->z); //[PLATFORM]-Del by TCTNB.WQF, 2012/9/6, Too much log output, note this log temp.
