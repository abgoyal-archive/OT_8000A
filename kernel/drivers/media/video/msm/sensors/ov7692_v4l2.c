 ...
 * --------------------------------------------------------------------------------------
 * 12/11/08      Zhang Lu       Modify settings, improve the performance for scribe5
 * 12/12/28      Zhang Lu       Modify settings, adjust framerate for scribe5
 * --------------------------------------------------------------------------------------
 */
...
static struct msm_camera_i2c_reg_conf ov7692_recommend_settings[] = {
    ...
    {0x2b, 0x08},
    {0x2c, 0x66},
    {0x15, 0xa4}, // enable night mode from 4x gain
    {0x2d, 0x00},
    {0x2e, 0x00},
    ////===remove light band===////
    {0x13, 0xef},
