...
/* ----------|----------------------|----------------------|----------------- */
/* 02/01/2013|pengdong.su           |PR-402535             |over expourse     */
/******************************************************************************/
...
//[BUGFIX]-Mod-BEGIN by TCTNB.pengdong.su,02/01/2013,402535,over expourse
#ifdef CONFIG_MACH_MSM8X25_SCRIBE5
#include <linux/gpio.h>
#include <linux/delay.h>
#endif
//[BUGFIX]-Mod-END by TCTNB.pengdong.su
...
//[BUGFIX]-Mod-BEGIN by TCTNB.pengdong.su,02/01/2013,402535,for camera on scrible5,to use the puls led
//to adjust the camera's needs
#ifdef CONFIG_MACH_MSM8X25_SCRIBE5
static void camera_flash_led_set(int gpio, int pulse)
{
...
//[BUGFIX]-Mod-BEGIN by TCTNB.pengdong.su,02/01/2013,402535,for camera on scrible5,to solve
// the over expousre in dark place with led on
