...
/*[PLATFORM]-Add-BEGIN by TCTNB.WQF, 2012/10/25, Add the ext amp control for speaker mode for viper*/
#ifdef CONFIG_MACH_MSM8X30_VIPER
#define GPIO_EXT_AMP_EN 50
#endif
...
/*[PLATFORM]-Add-BEGIN by TCTNB.WQF, 2012/10/25, Add the PA control for HAC function for viper*/
#ifdef CONFIG_MACH_MSM8X30_VIPER
static int msm8930_hac_control = 0;
#endif
/*[PLATFORM]-Add-END by TCTNB.WQF*/
...
static const struct snd_soc_dapm_route common_audio_map[] = {
	...
	/* Microphone path */
/*[PLATFORM]-Mod-BEGIN by TCTNB.WQF, 2012/11/06, Use micbias1 for AMIC1 for viper*/
#ifdef CONFIG_MACH_MSM8X30_VIPER
	{"AMIC1", NULL, "MIC BIAS1 Internal1"},
	{"MIC BIAS1 Internal1", NULL, "ANCLeft Headset Mic"},
#else
...
/*[PLATFORM]-Mod-BEGIN by TCTNB.WQF, 2012/11/06, Use micbias1 for AMIC3 for viper*/
#ifdef CONFIG_MACH_MSM8X30_VIPER
	{"AMIC3", NULL, "MIC BIAS1 Internal1"},
	{"MIC BIAS1 Internal1", NULL, "ANCRight Headset Mic"},
#else
...
/*[PLATFORM]-Add-BEGIN by TCTNB.WQF, 2012/10/25, Add the PA control for HAC function for viper*/
#ifdef CONFIG_MACH_MSM8X30_VIPER
static const char *hac_function[] = {"Off", "On"};
#endif
/*[PLATFORM]-Add-END by TCTNB.WQF*/
...
/*[PLATFORM]-Add-BEGIN by TCTNB.WQF, 2012/10/25, Add the PA control for HAC function for viper*/
#ifdef CONFIG_MACH_MSM8X30_VIPER
	SOC_ENUM_SINGLE_EXT(2, hac_function),
#endif
/*[PLATFORM]-Add-END by TCTNB.WQF*/
};
...
/*[PLATFORM]-Add-BEGIN by TCTNB.WQF, 2012/10/25, Add the PA control for HAC function for viper*/
#ifdef CONFIG_MACH_MSM8X30_VIPER
	SOC_ENUM_EXT("HAC PA Enable", msm8930_enum[3], msm8930_get_hac,
		msm8930_set_hac),
#endif
/*[PLATFORM]-Add-END by TCTNB.WQF*/
...
/*[PLATFORM]-Add-BEGIN by TCTNB.WQF, 2012/10/25, Add the ext amp control for speaker mode for viper*/
#ifdef CONFIG_MACH_MSM8X30_VIPER
	err = gpio_request(GPIO_EXT_AMP_EN, "gpio_ext_amp_en");
	if (err < 0) {
	...
	err = gpio_direction_output(GPIO_EXT_AMP_EN, 0);
	if (err < 0) {
