...
/* [PLATFORM]-Add-BEGIN by TCTNB.Alvin, 2012/10/15,  Add NT35516 for Viper */
#define MIPI_CMD_NT35516_QHD_PANEL_NAME "mipi_cmd_nt35516_qhd"
...
{
/* [PLATFORM]-Mod-BEGIN by TCTNB.Alvin, 2012/10/15,  Use NT35516 for Viper */
#if 1
	if (!strncmp(name, MIPI_CMD_NT35516_QHD_PANEL_NAME,
			strnlen(MIPI_CMD_NT35516_QHD_PANEL_NAME,
				PANEL_NAME_MAX_LEN)))
		return 0;
#else
...
/* [PLATFORM]-Mod-BEGIN by TCTNB.Alvin, 2012/10/15,  Change the lcd reset signal */
#if 0
		usleep(10000);
...
/* [PLATFORM]-Add-BEGIN by TCTNB.Alvin, 2012/10/15,  Add nt35516 data for viper */
static struct mipi_dsi_phy_ctrl dsi_nt35516_cmd_mode_phy_db = {
...
static struct mipi_dsi_panel_platform_data nt35516_pdata = {
    .phy_ctrl_settings = &dsi_nt35516_cmd_mode_phy_db,
    .dlane_swap = 0x1,
    .enable_wled_bl_ctrl = 0x1,
};
...
/* [PLATFORM]-Add-BEGIN by TCTNB.Alvin, 2012/10/15,  Add NT35516 for Viper */
    platform_device_register(&mipi_dsi_nt35516_panel_device);
/* [PLATFORM]-Add-END by TCTNB.Alvin */
