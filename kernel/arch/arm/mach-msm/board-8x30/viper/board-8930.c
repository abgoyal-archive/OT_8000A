...
/*[FEATURE]-Add-BEGIN by TCTNB.WPL, 2012/11/01, FR-318625*/
...
/*[PLATFORM]-Mod-BEGIN by TCTNB.WQF, 2012/11/06, Modify bias1_cap_mode for viper*/
...
#define FT5X06_IRQ_GPIO		11
#define FT5X06_RESET_GPIO	52

static ssize_t ft5x06_virtual_keys_register(struct kobject *kobj,
			     struct kobj_attribute *attr,
			     char *buf)
{
/*[FEATURE]-Mod-BEGIN by TCTNB.WPL, 2012/11/01, for viper TP*/
	return snprintf(buf, 200,
	__stringify(EV_KEY) ":" __stringify(KEY_MENU)  ":450:1030:190:60"
	":" __stringify(EV_KEY) ":" __stringify(KEY_HOME)   ":260:1030:190:60"
//	":" __stringify(EV_KEY) ":" __stringify(KEY_SEARCH) ":40:1030:190:60"
	":" __stringify(EV_KEY) ":" __stringify(KEY_BACK)   ":70:1030:190:60"
	"\n");
...
static void __init ft5x06_init_vkeys_8930(void)
{
	int rc = 0;
...
#define GPIO_TAOS_TMD2771x_INT 49
static struct i2c_board_info taos_i2c_info[] __initdata = {
	{
...
#ifdef CONFIG_SENSORS_AK8963
#define COMPASS_DRDY   (70)
#define GPIO_COMPASS_RESET (36)

static int bcm_akm8963_gpio_setup(void)
{
	int rc = 0;
...
#define GPIO_ACC_INT1 46
#define GPIO_ACC_INT2 67
