...
/*[FEATURE]-Add-BEGIN by TCTNB.WPL, 2012/11/08, FR-350991*/
...
/*[PLATFORM]-Add-BEGIN by TCTNB.WQF, 2012/11/01, Modify the keyboard backlight and flash led control for viper*/
#ifdef CONFIG_MACH_MSM8X30_VIPER
	[1] = {
		.name			= "led_red",
