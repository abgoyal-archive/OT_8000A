 ...
 * -----------------------------------------------------------------------------
 * 12/09/28       YuBin       Modified battery information.
 * 12/11/01       Yubin       Modified battery capacity parameters.
 * 12/11/09       TangDing    Modified cdrom.
 * 12/12/11       XuNan       Camera time performance
 * -----------------------------------------------------------------------------
 */
...
static struct msm_i2c_platform_data msm_gsbi0_qup_i2c_pdata = {
	//[BUGFIX]-Mod by TCTBN.XuNan,12/11/2012,PR347828,time performance
...
#define MSM_PMEM_ADSP_SIZE      0x193d000//[PLATFORM]-Mod-BEGIN by TCTNB.ZL, 2013/01/21, mod the PMEM size, refer to bug389188
...
/*[PLATFORM]-Mod-BEGIN by TCTNB.YuBin, 2012/9/11, modified battery info for scribe5*/
...
/*[PLATFORM]-Mod-BEGIN by TCTNB.YuBin, 2012/9/11, Using NCP1851 for scribe5*/
#ifdef CONFIG_CHARGER_IC_NCP1851
static struct i2c_board_info ncp_i2c_info[] __initdata = {
	{
		I2C_BOARD_INFO("ncp", 0x36),
		.platform_data =  NULL,
...
{
	printk(KERN_INFO "[NCP]register ncp i2c device.[NCP]\n");
	i2c_register_board_info(MSM_GSBI1_QUP_I2C_BUS_ID,
				ncp_i2c_info,
				ARRAY_SIZE(ncp_i2c_info));
}
#endif
/*[PLATFORM]-Mod-END by TCTNB.YuBin*/
